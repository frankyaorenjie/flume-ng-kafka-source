...
/**
 * A Source for Kafka which reads messages from kafka. I use this in company
 * production environment and its performance is good. Over 100k messages per
 * second can be read from kafka in one source.<p>
